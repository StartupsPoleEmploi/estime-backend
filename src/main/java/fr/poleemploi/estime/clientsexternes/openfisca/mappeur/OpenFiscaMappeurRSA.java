...
public class OpenFiscaMappeurRSA {
    ...
    public float getMontantRSA(String jsonResponse, LocalDate dateDebutSimulation, int numeroMoisSimule) {
        try {
            ...
            String periodeFormateeRSA = openFiscaPeriodeMappeur.getPeriodeOpenfiscaCalculAides(dateDebutSimulation, numeroMoisSimule);
    ...
    public JSONObject creerRSAJson(LocalDate dateDebutSimulation, int numeroMoisSimule) throws JSONException {        
        JSONObject rsaJSON = new JSONObject();
        rsaJSON.put(openFiscaPeriodeMappeur.getPeriodeOpenfiscaCalculAides(dateDebutSimulation, numeroMoisSimule), JSONObject.NULL);
        return rsaJSON;
    }
}
