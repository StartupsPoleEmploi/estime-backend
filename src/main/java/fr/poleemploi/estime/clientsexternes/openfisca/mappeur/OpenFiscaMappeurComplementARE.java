...
public class OpenFiscaMappeurComplementARE {
	...
	openFiscaIndividu.setNombreJoursRestantsARE(openFiscaPeriodeMappeur
		.creerPeriodeUniqueEffectiveDeuxiemeMoisOpenFisca(areUtile.getNombreJoursRestantsApresPremierMois(demandeurEmploi, dateDebutSimulation), dateDebutSimulation));

	openFiscaIndividu.setNombreJoursIndemnisesComplementARE(openFiscaPeriodeMappeur.creerPeriodesCalculeesEffectiveDeuxiemeMoisOpenFisca(dateDebutSimulation));
	openFiscaIndividu.setComplementAREBrut(openFiscaPeriodeMappeur.creerPeriodesCalculeesEffectiveDeuxiemeMoisOpenFisca(dateDebutSimulation));
	openFiscaIndividu.setDeductionsComplementARE(openFiscaPeriodeMappeur.creerPeriodesCalculeesEffectiveDeuxiemeMoisOpenFisca(dateDebutSimulation));
	openFiscaIndividu.setComplementARENet(openFiscaPeriodeMappeur.creerPeriodesCalculeesEffectiveDeuxiemeMoisOpenFisca(dateDebutSimulation));
