...
public class AgepiPEIOIn {
	...
	return "AgepiPEIOIn [codeTerritoire=" + codeTerritoire + ", origine=" + origine + ", dateDepot=" + dateDepot + ", dateActionReclassement=" + dateActionReclassement
		+ ", contexte=" + contexte + ", natureContratTravail=" + natureContratTravail + ", lieuFormationOuEmploi=" + lieuFormationOuEmploi + ", typeIntensite="
		+ typeIntensite + ", intensite=" + intensite + ", dureePeriodeEmploiOuFormation=" + dureePeriodeEmploiOuFormation + ", nombreEnfants=" + nombreEnfants
		+ ", nombreEnfantsMoins10Ans=" + nombreEnfantsMoins10Ans + ", eleveSeulEnfants=" + eleveSeulEnfants + "]";
    }
}
