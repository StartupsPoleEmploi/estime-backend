...
public class ConditionsAideMobiliteAPI {
	...
	return "ConditionsAideMobiliteAPI [conditionChampTerritorial=" + conditionChampTerritorial + ", conditionDateDepot=" + conditionDateDepot + ", conditionDistance="
		+ conditionDistance + ", conditionDuree=" + conditionDuree + ", conditionInscription=" + conditionInscription + ", conditionPriseEnCharge=" + conditionPriseEnCharge
		+ ", conditionRessource=" + conditionRessource + "]";
    }
