...
public class ConditionAGEPIAPI {
    ...
    public void setConditionDureeEntreFaitsGenerateurs(ConditionDureeEntreFaitsGenerateurs conditionDureeEntreFaitsGenerateurs) {
	...
	return "ConditionAGEPIAPI [conditionDureeEntreFaitsGenerateurs=" + conditionDureeEntreFaitsGenerateurs + ", conditionInscription=" + conditionInscription
		+ ", conditionGardeEnfant=" + conditionGardeEnfant + ", conditionChampTerritorial=" + conditionChampTerritorial + ", conditionDuree=" + conditionDuree
		+ ", conditionRessource=" + conditionRessource + ", conditionDateDepot=" + conditionDateDepot + "]";
    }
