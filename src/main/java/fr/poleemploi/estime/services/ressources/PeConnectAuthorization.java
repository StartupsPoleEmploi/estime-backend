...
public class PeConnectAuthorization {
	...
	return "PeConnectAuthorization [bearerToken=" + bearerToken + ", expireIn=" + expireIn + ", idToken=" + idToken + ", refreshToken=" + refreshToken + ", scope=" + scope
		+ ", tokenType=" + tokenType + ", expireInDate=" + expireInDate + "]";
    }
}
