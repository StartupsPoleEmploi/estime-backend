...
public class FuturTravail {
	...
	return "FuturTravail [distanceKmDomicileTravail=" + distanceKmDomicileTravail + ", nombreHeuresTravailleesSemaine=" + nombreHeuresTravailleesSemaine
		+ ", nombreMoisContratCDD=" + nombreMoisContratCDD + ", nombreTrajetsDomicileTravail=" + nombreTrajetsDomicileTravail + ", salaire=" + salaire + ", typeContrat="
		+ typeContrat + "]";
    }
}
