...
public enum MessageInformatifEnum {
    ...
    FIN_DE_DROIT_ARE(
	    "À l'issu de ce mois, vous ne percevrez plus l'ARE car votre reliquat sera épuisé sauf si un rechargement ou une ouverture de droit ASS a lieu à ce moment-là. Renseignez-vous sur vos potentiels nouveaux droits auprès de votre agence Pôle emploi"),
    ACTUALISATION_ARE(
	    "Pensez à faire votre actualisation mensuelle auprès de Pôle emploi pour rester inscrit et recevoir l'allocation d'Aide au Retour à l'Emploi en complément de votre salaire."),
    ...
    RSA_AIDES_DEPARTEMENTALES(
	    "Certains départements proposent des aides complémentaires pour les bénéficiaires du RSA qui reprennent un emploi. Rapprochez-vous de votre conseiller référent pour plus d’informations."),
