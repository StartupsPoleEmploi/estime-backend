...
public enum LoggerMessages {
    ...
    MAILJET_CONTACT_DEJA_ENREGISTRE("Création du contact impossible car un contact avec %s pour email existe déjà."),
    MAILJET_AJOUT_CONTACT_A_LA_LISTE_KO("Erreur Technique : ajout du contact à la liste de contacts impossible dûe à l'erreur : %s."),
    MAILJET_AJOUT_CONTACT_A_LA_LISTE_DEJA_ENREGISTRE("Le contact ayant pour email %s ne peut pas être ajouté car il est déjà présent dans la liste."),
