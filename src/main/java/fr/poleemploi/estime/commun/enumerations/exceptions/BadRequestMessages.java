...
public enum BadRequestMessages {
	...
	INDIVIDU_OBLIGATOIRE("Des informations de l'individu sont obligatoires."),
	MONTANT_INCORRECT_INFERIEUR_EGAL_ZERO("Le montant de %s doit être supérieur à 0."),
	RESSOURCES_FINANCIERES_SANS_MONTANT_SOURCE_FINANCIERE("Si ressources financieres %s de renseignées, un montant doit obligatoirement être renseigné (salaire, montant d'une aide, etc...) "),
	SALAIRE_MENSUEL_BRUT_ZERO("Le salaire mensuel brut ne peut pas être égale à 0"),
    ...
    VALEUR_INCORRECT_PROCHAINE_DECLARATION_RSA("La valeur de prochaine déclaration RSA est incorrect (inférieure à 0 ou supérieur à 3) : %s");
