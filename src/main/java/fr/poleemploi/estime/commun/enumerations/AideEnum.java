...
public enum AideEnum {
    ...
    AIDE_RETOUR_EMPLOI("ARE", "Allocation de Retour à l'Emploi", ""),
    ...
    ALLOCATION_SUPPLEMENTAIRE_INVALIDITE("ASI", "Allocation Supplémentaire d'Invalidité", ""),
    ...
    IMMOBILIER("IMMO", "Revenus immobiliers",""),
    MICRO_ENTREPRENEUR("MICRO", "Revenus micro-entreprise",""),
