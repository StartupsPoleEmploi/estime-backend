...
public enum AideEnum {
    ...
    COMPLEMENT_AIDE_RETOUR_EMPLOI("ARE", "Complément d'Allocation de Retour à l'Emploi", ""), ALLOCATION_ADULTES_HANDICAPES("AAH", "Allocation aux Adultes Handicapés", "aah.html"),
    ALLOCATION_LOGEMENT_FAMILIALE("ALF", "Allocation de Logement Familiale", ""), ALLOCATION_LOGEMENT_SOCIALE("ALS", "Allocation de Logement Sociale", ""),
