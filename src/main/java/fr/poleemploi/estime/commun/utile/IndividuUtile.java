...
public class IndividuUtile {
    ...
    private boolean isBeneficiaireARE(DetailIndemnisationPEIOOut detailIndemnisationESD) {
        return detailIndemnisationESD.getCodeIndemnisation() != null && TypePopulationEnum.ARE.getLibelle().equals(detailIndemnisationESD.getCodeIndemnisation());
    }

    private boolean isBeneficiaireASS(DetailIndemnisationPEIOOut detailIndemnisationESD) {
        return detailIndemnisationESD.getCodeIndemnisation() != null && TypePopulationEnum.ASS.getLibelle().equals(detailIndemnisationESD.getCodeIndemnisation());
    }
}
