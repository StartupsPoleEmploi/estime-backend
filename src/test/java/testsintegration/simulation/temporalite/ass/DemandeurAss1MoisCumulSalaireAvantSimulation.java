...
class DemandeurAss1MoisCumulSalaireAvantSimulation extends CommunTests {
    ...
    @Test
    void simulerPopulationAssCumulSalaire1Mois() throws ParseException, JsonIOException, JsonSyntaxException,
    FileNotFoundException, URISyntaxException, JSONException {
        ...
        assertThat(simulationMois1).satisfies(simulation -> {
            ...
            assertThat(simulation.getMesPrestationsSociales().get(PrestationsSociales.ALLOCATION_SOLIDARITE_SPECIFIQUE.getCode()))
            .satisfies(ass -> {
        ...
        assertThat(simulationMois3).satisfies(simulation -> {
            ...
            assertThat(simulation.getMesPrestationsSociales().size()).isEqualTo(0);
        });
