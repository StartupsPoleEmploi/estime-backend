...
class DemandeurTravailleurIndependantTests extends Commun {
	...
	demandeurEmploi.getRessourcesFinancieres().setChiffreAffairesIndependantDernierExercice(1200f);
	...
	assertThat(simulationMois1).satisfies(simulation -> {
	    ...
	    assertThat(simulation.getMesAides().get(AideEnum.TRAVAILLEUR_INDEPENDANT.getCode())).satisfies(indep -> {
