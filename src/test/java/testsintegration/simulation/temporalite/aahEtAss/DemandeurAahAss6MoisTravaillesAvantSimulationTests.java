...
class DemandeurAahAss6MoisTravaillesAvantSimulationTests extends Commun {
	...
	demandeurEmploi.getRessourcesFinancieresAvantSimulation().setPeriodeTravailleeAvantSimulation(utileTests.creerPeriodeTravailleeAvantSimulation(1101, 850, 6));
