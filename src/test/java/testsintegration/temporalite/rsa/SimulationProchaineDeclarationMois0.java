...
class SimulationProchaineDeclarationMois0 {
    ...
    private static final Integer PROCHAINE_DECLARATION_RSA = 0;
    ...
    @Test
    void simulerMesAidesSocialesProchaineDeclarationRSAMois0Test1() throws ParseException, JsonIOException, JsonSyntaxException, FileNotFoundException, URISyntaxException, JSONException {
    ...
    @Test
    void simulerMesAidesSocialesProchaineDeclarationRSAMois0Test2() throws ParseException, JsonIOException, JsonSyntaxException, FileNotFoundException, URISyntaxException, JSONException {
    ...
    @Test
    void simulerMesAidesSocialesProchaineDeclarationRSAMois0Test3() throws ParseException, JsonIOException, JsonSyntaxException, FileNotFoundException, URISyntaxException, JSONException {
        ...
        //Alors les aides du sixième mois 04/2021 sont :
        //Prime d'activité : 429 euros (Simulateur CAF : ? euros), RSA : 148f (simulateur CAF : ? euros)
        SimulationMensuelle simulationMois6 = simulationAidesSociales.getSimulationsMensuelles().get(5);
        assertThat(simulationMois6).satisfies(simulation -> { 
            assertThat(simulation.getDatePremierJourMoisSimule()).satisfies(dateMoisSimule -> {
                assertThat(dateUtile.getMonthFromLocalDate(dateMoisSimule)).isEqualTo("04");
    ...
    @Test
    void simulerMesAidesSocialesProchaineDeclarationRSAMois0Test4() throws ParseException, JsonIOException, JsonSyntaxException, FileNotFoundException, URISyntaxException, JSONException {
        ...
        //Alors les aides du cinquième mois 03/2021 sont :
        //Prime d'activité : 287 euros (Simulateur CAF : ? euros), RSA : 381f (simulateur CAF : ? euros)
        SimulationMensuelle simulationMois5 = simulationAidesSociales.getSimulationsMensuelles().get(4);
        assertThat(simulationMois5).satisfies(simulation -> { 
            assertThat(simulation.getDatePremierJourMoisSimule()).satisfies(dateMoisSimule -> {
                assertThat(dateUtile.getMonthFromLocalDate(dateMoisSimule)).isEqualTo("03");
