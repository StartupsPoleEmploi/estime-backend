...
class OpenFiscaMappeurPeriodesTestsRSA extends CommunTests {
    ...
    /**
     * Demandeur RSA, déclaration en M, calcul RSA en M3 a travaillé avant
     * simulation en juillet et juin
     * 
     */
    @Test
    void mapPeriodeSalaireTest1() throws JSONException, JsonParseException, JsonMappingException, IOException,
        ...
        int nbEnfant = 0;
        DemandeurEmploi demandeurEmploi = utileTests.creerBaseDemandeurEmploi(TypePopulation.RSA.getLibelle(),
                isEnCouple, nbEnfant);
        ...
        salaireMoisDemande.setMontantNet(380);
        salaireMoisDemande.setMontantBrut(508);
        ...
        salaireMoisMoins1Mois.setMontantNet(380);
        salaireMoisMoins1Mois.setMontantBrut(508);
    ...
    /**
     * Demandeur RSA, déclaration en M1, calcul RSA en M1 a travaillé avant
     * simulation en juillet et juin
     * 
     */
    @Test
    ...
    /**
     * Demandeur RSA, déclaration en M1, calcul RSA en M4 a travaillé avant
     * simulation en juillet et juin
     * 
     */
    @Test
    ...
    /**
     * Demandeur RSA, déclaration en M2, calcul RSA en M2 a travaillé avant
     * simulation en juillet et juin
     * 
     */
    @Test
    ...
    /**
     * Demandeur RSA, déclaration en M2, calcul RSA en M5 a travaillé avant
     * simulation en juillet et juin
     * 
     */
    @Test
    ...
    /**
     * Demandeur RSA, déclaration en M3 a travaillé avant simulation en juillet et
     * juin
     * 
     */
    @Test
     ...
     */
    @Test
    void mapPeriodeSalaireTest7() throws JSONException, JsonParseException, JsonMappingException, IOException,
            URISyntaxException, ParseException {
