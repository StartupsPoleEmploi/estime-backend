...
class OpenFiscaMappeurPeriodeAAHTests extends Commun {
	...
	OpenFiscaPeriodes periodeAideeAAH = openFiscaMappeurPeriode.creerPeriodesOpenFiscaAide(demandeurEmploi, simulation, codeAideAAH, dateDebutSimulation, numeroMoisSimule);
	...
	int nbEnfant = 0;
	DemandeurEmploi demandeurEmploi = utileTests.creerBaseDemandeurEmploi(TypePopulationEnum.AAH.getLibelle(), isEnCouple, nbEnfant);
	demandeurEmploi.getRessourcesFinancieresAvantSimulation().getAidesCAF().setAllocationAAH(montantAAH);
